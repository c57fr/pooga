...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark navBarLeft fixed-top" style="justify-content:flex-start">
	...
	<a class="topbar-logo" href="https://www.grafikart.fr/formations/programmation-objet-php/objets-poo"
	   title="Tuto GrafikArt" target="_blank">
	...
	<a href="/?a=admin.posts.index" class="navbar-brand">Admin</a>

	<a class="topBarLogoGc7" href="/aGc7/AutoMenu/adminAM.php" title=" <?= $_SERVER[ 'REQUEST_URI' ] ?> "
	   alt="Logo Gc7"><img
